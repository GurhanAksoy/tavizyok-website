    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-100 to-white text-gray-900 font-sans">
      ...
      <div className="flex flex-col items-center justify-center text-center px-4 py-16">
        ...
        <a
          ...
          className="inline-flex items-center px-6 py-3 mt-6 bg-[#25D366] text-white text-base font-semibold rounded-full shadow-md hover:bg-[#1ebe5d] transition duration-300"
        >
          <svg
