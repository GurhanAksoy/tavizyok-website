...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#f5f5f4] text-gray-900 font-sans">
      <Navbar />
      <div className="flex flex-col items-center justify-center text-center px-4 py-16 relative z-10">
        ...
        >
          📲 <span className="text-white ml-2">WhatsApp Bildirim Gönder</span>
        </a>
      </div>
      ...
      <div className="px-6 md:px-12 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-md p-6 text-left">
            ...
            <p className="text-sm text-gray-700">
              Videonuz ekibimiz tarafından incelenir. Uygun görülmesi halinde ilgili kuruma iletilir.
