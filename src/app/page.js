...
const SHARE_TITLE = 'TAVİZ YOK | Vatandaş Haberciliği & İhbar Platformu';
...
function ShareSection() {
  ...
  const whatsappShare = `https://wa.me/?text=${encodeURIComponent(SHARE_TEXT + '\n' + SITE_URL)}`;
  const twitterShare = `https://twitter.com/intent/tweet?text=${encodeURIComponent(SHARE_TEXT)}&url=${encodeURIComponent(SITE_URL)}`;
  const facebookShare = `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(SITE_URL)}`;
    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 text-gray-900 font-sans">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="flex flex-col items-center justify-center text-center px-4 py-20 md:py-28 relative z-10">
          ...
          {/* Main Message */}
          <div className="text-center max-w-4xl mx-auto space-y-6 mb-12 w-full">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
              Haksızlığa <span className="text-red-600">Sessiz Kalmayın</span>
            </h1>

            {/* İhbar + Vatandaş Haberciliği */}
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl p-6 md:p-10 border border-gray-200">
              <div className="space-y-6 text-base md:text-lg text-gray-700 leading-relaxed">

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                  {/* İhbar Kartı */}
                  <div className="bg-gradient-to-br from-red-50 to-white rounded-2xl p-5 md:p-6 border-2 border-red-200">
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-5 md:p-6 border-2 border-blue-200">
                    <div className="text-4xl mb-3 text-center">📰</div>
                ...
                <div className="bg-gray-50 rounded-2xl p-4 md:p-5 border border-gray-200">
                  <div className="flex items-center justify-center gap-2 md:gap-3 flex-wrap text-sm md:text-base">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-center w-full max-w-sm sm:max-w-none">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full sm:w-auto group relative inline-flex items-center justify-center px-8 md:px-10 py-4 bg-[#25D366] text-white text-lg font-bold rounded-2xl shadow-lg hover:shadow-xl hover:bg-[#20BD5A] hover:scale-105 transition-all duration-300 border-2 border-[#25D366] hover:border-[#20BD5A]"
            >
              <span className="text-2xl mr-3">📲</span>
              <span>Video Gönder</span>
              <span className="ml-2 group-hover:translate-x-1 transition-transform">→</span>
            </a>

            <a
              href="https://wa.me/905304066686?text=Merhaba%2C%20bir%20haks%C4%B1zl%C4%B1k%20bildirmek%20istiyorum."
              target="_blank"
              rel="noopener noreferrer"
              className="w-full sm:w-auto group relative inline-flex items-center justify-center px-8 md:px-10 py-4 bg-red-600 text-white text-lg font-bold rounded-2xl shadow-lg hover:shadow-xl hover:bg-red-700 hover:scale-105 transition-all duration-300 border-2 border-red-600 hover:border-red-700"
            >
              <span className="text-2xl mr-3">🚨</span>
              <span>Haksızlık Bildir</span>
              <span className="ml-2 group-hover:translate-x-1 transition-transform">→</span>
            </a>
          </div>

          {/* Trust Indicators */}
          <div className="mt-10 flex flex-wrap justify-center gap-3 md:gap-4 text-sm text-gray-600">
            {['KVKK Uyumlu', 'Gizlilik Garantisi', 'Editörlük Süreci', 'Sosyal Medya Yayını'].map((item) => (
              <div key={item} className="flex items-center gap-2 bg-white/60 backdrop-blur-sm px-4 py-2 rounded-full shadow-sm">
      ...
      {/* FAQ Section */}
      <div className="px-4 md:px-6 lg:px-12 py-16 bg-gradient-to-b from-white/50 to-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-3">
              <span className="text-red-600">Merak Ettikleriniz</span>
            </h2>
            <p className="text-gray-600 text-lg">Sıkça sorulan sorulara yanıtlar</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {/* Card 1 */}
            <div className="bg-gradient-to-br from-white to-gray-50 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 md:p-8 border-2 border-gray-200 hover:border-red-300 group relative overflow-hidden">
            ...
            <div className="bg-gradient-to-br from-white to-gray-50 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 md:p-8 border-2 border-gray-200 hover:border-red-300 group relative overflow-hidden">
              ...
              <div className="text-gray-700 leading-relaxed space-y-3 text-sm">
                {[
                  { icon: '📋', title: 'İnceleme', desc: 'İçerik ve kalite kontrolü' },
                  { icon: '🏛️', title: 'İhbar Videoları', desc: 'İlgili kuruma iletilir' },
                  { icon: '📱', title: 'Haber İçerikleri', desc: 'Sosyal medyada yayınlanır' },
                ].map((item) => (
                  <div key={item.title} className="flex items-start gap-3 bg-gray-50 rounded-xl p-3 border border-gray-200">
                ...
                <p className="text-gray-500 text-xs pt-2 text-center italic">
                  * Sosyal medya yayını için platforma abone olunması gerekir
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-white to-gray-50 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 md:p-8 border-2 border-gray-200 hover:border-red-300 group relative overflow-hidden">
              ...
              <div className="text-gray-700 leading-relaxed space-y-2 text-sm">
                {[
                  ...
                  'Kamu yararı ve haber değeri taşımayan içerikler',
                  'Yer/zaman bilgisi veya görüntü kalitesi yetersiz kayıtlar',
                ].map((item) => (
                  <div key={item} className="flex items-start gap-2 bg-red-50 rounded-lg p-2 border border-red-100">
            ...
            <div className="bg-gradient-to-br from-white to-gray-50 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 md:p-8 border-2 border-gray-200 hover:border-red-300 group relative overflow-hidden">
              ...
              <div className="space-y-2 text-sm">
                {[
                  { icon: '🚗', title: 'Trafik', sub: 'Trafik Başkanlığı' },
                  { icon: '👮', title: 'Asayiş', sub: 'Emniyet Müdürlüğü' },
                  { icon: '🏥', title: 'Sağlık', sub: 'Sağlık Bakanlığı' },
                  { icon: '🐾', title: 'Hayvan Hakları', sub: 'Tarım ve Orman Bakanlığı' },
                ].map((item) => (
                  <div key={item.title} className="bg-blue-50 rounded-lg p-3 border border-blue-100 flex items-center gap-3">
                    <span className="text-2xl">{item.icon}</span>
                    <div>
                      <p className="font-semibold text-blue-700">{item.title}</p>
                      <p className="text-xs text-blue-600">{item.sub}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            {/* Card 7 — Full width */}
            <div className="bg-gradient-to-br from-red-50 via-white to-orange-50 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 p-8 md:p-10 border-2 border-red-300 md:col-span-2 lg:col-span-3 relative overflow-hidden">
      ...
      {/* Final CTA Section */}
      <div className="bg-gradient-to-r from-red-600 via-red-700 to-red-600 text-white py-12 px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">
            Tanık olduğunuz her önemli anı paylaşın
          </h2>
          <p className="text-base md:text-lg mb-6 opacity-95">
            Haksızlık mı gördünüz? Hayvan hakları ihlali mi? Habere değer bir olay mı yaşandı?<br className="hidden sm:block" />
