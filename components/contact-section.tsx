...
export default function ContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        setSubmitted(true)
        setFormData({ kurumAdi: "", yetkili: "", email: "", telefon: "", mesaj: "" })
            ...
            <div className="bg-white rounded-2xl md:rounded-3xl p-6 md:p-10 shadow-2xl">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                  ...
                  <button type="submit" disabled={loading} className="w-full flex items-center justify-center space-x-2 px-8 py-4 bg-gradient-to-r from-kirmizi-600 to-kirmizi-700 hover:from-kirmizi-700 hover:to-kirmizi-800 text-white rounded-xl font-bold text-base md:text-lg shadow-xl hover:shadow-2xl transition-all hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed">
